...
int main() {
    ...
    if ((r = socket->connect("nameless-journey-37973.herokuapp.com", 443)) != NSAPI_ERROR_OK) {
    ...
    while(1) {
        ...
        {
            HttpsRequest* post_temp = new HttpsRequest(socket, HTTP_POST, "https://nameless-journey-37973.herokuapp.com/temperature");
        ...
        {
            HttpsRequest* post_humid = new HttpsRequest(socket, HTTP_POST, "https://nameless-journey-37973.herokuapp.com/humidity");
